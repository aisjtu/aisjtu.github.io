...
<a target="\_blank" class="noCrossRef" href="{{ "Rsr_pdf/21/Notes_Data_Structure.pdf"}}"><button type="button" class="btn btn-default" aria-label="Left Align"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> PDF Download</button></a>
