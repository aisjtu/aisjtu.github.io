...
<a target="\_blank" class="noCrossRef" href="{{ "Rsr_pdf/21/线性优化凸优化.pdf"}}"><button type="button" class="btn btn-default" aria-label="Left Align"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> PDF Download</button></a>
...
<embed src="Rsr_pdf/21/线性优化凸优化.pdf" type="application/pdf" width="100%" height="100%"/>
