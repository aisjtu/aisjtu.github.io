...
<a target="\_blank" class="noCrossRef" href="{{ "Rsr_pdf/21/信号与系统简明笔记.pdf"}}"><button type="button" class="btn btn-default" aria-label="Left Align"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> PDF Download</button></a>
...
<embed src="Rsr_pdf/21/信号与系统简明笔记.pdf" type="application/pdf" width="100%" height="100%"/>
